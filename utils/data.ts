...
export const FaqAccordion = [
  {
    ...
    paragraphs: ["Конечно — вам и всем остальным участникам программы."],
  },
  {
  ...
  {
    title: "Я пока ничего не умею, но хочу научиться. Возьмете меня?",
    paragraphs: [
  ...
  {
    title: "Можно ли проходить стажировку удаленно?",
    paragraphs: [
