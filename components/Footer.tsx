  ...
  return (
    <footer className="base-max-width relative pt-[1.8rem]">
      ...
      <div className="text-center flex justify-center w-full text-black/60 text-[1.4rem] pt-[0.9rem] pb-[1.6rem]">
        <p className="max-w-[55rem] leading-[110%]">Предложение стажировки, её сроки и размер вознаграждения определяются <br /> по итогам собеседования и выполнения кандидатом тестовых заданий. <br /> Кандидату не гарантируется трудоустройство и соответствие <br /> вознаграждения его ожиданиям. <br />
